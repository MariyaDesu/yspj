  ...
  <n-space vertical>
    <n-space>
      <n-form inline :label-width="180" size="small" :show-feedback="false">
        <n-form-item label="支付编号" span="6" path="budControlPayCode">
        ...
        <n-form-item label="产权结构名称" span="6" path="assetName">
          <NSelect v-model:value="search.assetId" label-field="assetName" value-field="assetId" filterable
        ...
        <n-form-item label="管理结构名称" span="6" path="branchName">
          <NSelect v-model:value="search.branchId" filterable :options="options.deptStateOptions" label-field="branchName"
            value-field="branchId" placeholder="请选择" clearable @click="fetchDeptState" />
        </n-form-item>
        <n-form-item label="支付方式" span="6" path="payType">
          <NSelect v-model:value="search.payType" filterable :options="options.payTypeOptions" clearable
            label-field="dictValue" value-field="keyValue" placeholder="请选择" @click="getDictionaryDetailByKeyWord()" />
        </n-form-item>
        <n-form-item label="支付时间" span="6" path="payTime">
          <n-date-picker v-model:formatted-value="search.payTime" value-format="yyyy-MM-dd" type="date" clearable
