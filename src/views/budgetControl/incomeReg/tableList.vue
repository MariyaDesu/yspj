...
<template>
  ...
  >
    ...
    <vxe-column type="expand" title="" width="80" fixed="left">
      <template #content="{ row }">
        ...
        >
          ...
          <vxe-column field="commission" title="手续费" width="200" />
          <vxe-column field="actualAmount" title="实际收入金额" width="200" />
        </vxe-table>
      </template>
    </vxe-column>
    ...
    <vxe-column field="budControlPayCode" title="收入编号" width="200" />
    <vxe-column field="payTime" title="收入时间" width="200" />
    ...
    <vxe-column field="budPayMoney" title="收入总金额" width="200" />
    <vxe-column field="commissionSum" title="手续费总金额" width="200" />
    <vxe-column field="actualAmountSum" title="实际收入总金额" width="200" />
    <vxe-column field="dictValue" title="收入方式" width="100" />
