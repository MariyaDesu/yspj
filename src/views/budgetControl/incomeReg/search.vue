  ...
  <n-space vertical>
    <n-space>
      <n-form inline :label-width="180" size="small" :show-feedback="false">
        <n-form-item label="收入编号" span="6" path="budControlPayCode">
        ...
        <n-form-item label="收入方式" span="6" path="payType">
          <NSelect
        ...
        <n-form-item label="收入日期" span="6" path="payTime">
          <n-date-picker
