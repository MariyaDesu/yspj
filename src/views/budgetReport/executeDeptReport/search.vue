  ...
  <n-space vertical>
    ...
    >
      <n-grid :cols="24" :x-gap="24">
        <n-form-item-gi label="产权结构" span="5">
          <NSelect
        ...
        <n-form-item-gi label="管理结构" span="4">
          <NSelect
        ...
        <n-form-item-gi label="部门" span="4">
          <NCascader
        ...
        <n-form-item-gi label="预算类型" span="3">
          <NSelect
        ...
        <n-form-item-gi label="预算事项" span="4">
          <NInput v-model:value="search.compileName" />
        </n-form-item-gi>

        <n-form-item-gi label="分类" span="4">
          <NSelect
            v-model:value="Data.type" label-field="typeName" value-field="type" filterable
            :options="options.typeOption" placeholder="请选择" clearable @update:value="changeReport"
          />
        </n-form-item-gi>
        <!-- <n-form-item-gi label="是否有合同" span="4" mt-10>
          <NSelect
        ...
        <n-form-item-gi label="预算周期" span="5" mt-10>
          <n-date-picker
            v-model:value="timestamp" type="monthrange" clearable :style="{ width: '100%' }"
            @update:value="formatTime"
          />
        </n-form-item-gi>
        <n-form-item-gi label="立项名称" span="4" mt-10>
          <NInput v-model:value="search.projectName" />
        </n-form-item-gi>
        ...
        <n-form-item-gi label="包括未审核数据" span="3" mt-10>
          <n-switch
